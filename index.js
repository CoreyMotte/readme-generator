...
function questions(){
    return inquirer.prompt([
        ...
        },
        {
            type: 'input',
            name: 'install',
            message: 'Please input how to install this project.'
        },
        {
            type: 'input',
            name: 'usage',
        ...
        },
        {
            type: 'input',
            name: 'cont',
            message: 'Please input how to contribute to this project.'
        },
        {
            name: 'license',
        ...
        },
        {
            type: 'input',
            name: 'fileName',
            message: 'Please input the name of the generated file. (DO NOT include .md)'
        }
    ]);
}
